...
/**
 * Copyright 2022 Charles Swires All Rights Reserved
 * @author charl
 *
 */
@RestController
...
public class RController  {
    ...
    @GetMapping(path="/getId/{id}", produces="application/json")
    public ResponseEntity<ResponseBean> getId(@PathVariable("id") String id) {
        
        return new ResponseEntity<ResponseBean>(service.getId(id), HttpStatus.OK);
    }
